    ...
    return (
      <div className={`flex justify-center ${containerClassName}`}>
        <div 
          ...
          style={{ aspectRatio: fallbackAspectRatio, maxHeight, minHeight, width: '100%' }}
        >
    ...
    <div className={`flex justify-center ${containerClassName}`}>
      <div 
        ...
        style={{ 
          ...
          minHeight,
          width: '100%',
          maxWidth: aspectRatio && aspectRatio > 1 ? '100%' : `calc(${maxHeight} * ${aspectRatio || fallbackAspectRatio})`
        }}
      >
        <img
          src={src}
