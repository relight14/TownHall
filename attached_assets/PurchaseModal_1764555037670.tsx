...
export default function PurchaseModal({ episode, onClose, onSuccess }: PurchaseModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-slate-900 rounded-2xl max-w-lg w-full border border-slate-800 shadow-2xl">
        ...
        <div className="p-6">
          <div className="flex gap-4 mb-6">
            ...
            <div>
              <h3 className="text-white mb-2">{episode.title}</h3>
              <p className="text-slate-400 line-clamp-2">{episode.description}</p>
            </div>
          </div>
          ...
          <div className="bg-slate-800/50 rounded-lg p-4 mb-6 border border-slate-700">
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-white">${episode.price}</span>
            </div>
